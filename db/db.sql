...
create table tb_product (
    ...
    constraint fk_product foreign key (user_id) references tb_user(user_id)
);

alter table tb_product auto_increment = 1000,
alter column state set default "còn hàng",
alter column product_type set default "khác",
modify column is_deleted bool default false;
--------------------------------------------------------
...
insert into tb_product (user_id, product_name, price, description) values ("1000", "Quạt cây hehe", "120000", "Hàng mới mua về mới sử dụng có 2-3 lần và không có nhu cầu sử dụng nữa");
